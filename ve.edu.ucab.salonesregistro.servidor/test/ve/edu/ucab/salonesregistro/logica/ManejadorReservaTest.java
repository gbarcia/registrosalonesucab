 ...
 */
public class ManejadorReservaTest {

    public ManejadorReservaTest() {
    }
    ...
    /**
     * Test of realizarReserva method, of class ManejadorReserva.
     */
    @Test
    public void testRealizarReserva() {
        ...
        ManejadorReserva instance = new ManejadorReserva();
