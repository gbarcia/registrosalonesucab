...
public class ManejadorSalon implements Serializable {
    ...
    public ManejadorSalon() {
        try {
            ...
            this.sync = (Isincronizacion) Naming.lookup("rmi://" + ipReplica + ":1099/Sincronizacion");
            this.replicaActivada = true;
            bitacora.info("enlaze con la replica satisfactorio " + ipReplica);
